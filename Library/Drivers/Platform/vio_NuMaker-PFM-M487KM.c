/******************************************************************************
 * @file     vio_NuMaker-PFM-M487KM.c
 * @brief    Virtual I/O implementation for board Nuvoton NuMaker-PFM-M487KM
 * @version  V1.1.0
...
/*! \page vio_NuMaker-PFM-M487KM Physical I/O Mapping

The table below lists the physical I/O mapping of this CMSIS-Driver VIO implementation.

Virtual Resource  | Variable       | Physical Resource on Nuvoton NuMaker-PFM-M487KM |
:-----------------|:---------------|:------------------------------------------------|
vioBUTTON0        | vioSignalIn.0  | SW2/PG.15                                       |
vioBUTTON1        | vioSignalIn.1  | SW3/PF.11                                       |
vioLED0           | vioSignalOut.0 | LEDR/PH.4                                       |
vioLED1           | vioSignalOut.1 | LEDG/PH.5                                       |
*/
...
void vioInit(void)
{
    ...
    // Configure pins: Output Mode with Pull-down resistors, LED0
    GPIO_SetMode(PH, BIT4, GPIO_MODE_OUTPUT);
    // Configure pins: Output Mode with Pull-down resistors, LED1
    ...
    // Configure pins: Input Mode, SW2
    GPIO_SetMode(PG, BIT15, GPIO_MODE_INPUT);
    // Configure pins: Input Mode, SW3
